...
La sección **Sub serie / Descripción / Folio** permite agregar varios cuadros por página con **+ Agregar cuadro**. Cada cuadro se convierte en una fila adicional de la tabla de la plantilla Word, copiando el formato de la fila original.

Los respaldos nuevos usan `pangoa_word_pages_v2`; los respaldos de la versión anterior se migran automáticamente y conservan descripción y folio como el primer cuadro.
